...
void Init_Video()
{
	...
	sdl_screen = SDL_SetVideoMode(320, 200, 16, SDL_HWSURFACE);
...
//#endif
	...
	switch(option.fullscreen) 
	{
		...
		case 1:
		{
			...
			bitmap_scale(0, 0, internal_width, internal_height, 240, 180, internal_width, 240, (uint16_t* restrict)source_graph, (uint16_t* restrict)sdl_screen->pixels);

...
void Init_Video()
{
	...
	sdl_screen = SDL_SetVideoMode(320, 200, 32, SDL_HWSURFACE);
	
	backbuffer = SDL_CreateRGBSurface(SDL_HWSURFACE, HOST_WIDTH_RESOLUTION, HOST_HEIGHT_RESOLUTION, 32, 0,0,0,0);
	
	wswan_vs = SDL_CreateRGBSurface(SDL_HWSURFACE, INTERNAL_WSWAN_WIDTH, INTERNAL_WSWAN_HEIGHT, 32, 0,0,0,0);
	
	wswan_vs_rot = SDL_CreateRGBSurface(SDL_HWSURFACE, INTERNAL_WSWAN_HEIGHT, INTERNAL_WSWAN_WIDTH, 32, 0,0,0,0);

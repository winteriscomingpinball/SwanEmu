...
void Init_Video()
{
	...
	sdl_screen = SDL_SetVideoMode(HOST_WIDTH_RESOLUTION, HOST_HEIGHT_RESOLUTION, 32, SDL_HWSURFACE);
	
	backbuffer = SDL_CreateRGBSurface(SDL_HWSURFACE, HOST_WIDTH_RESOLUTION, HOST_HEIGHT_RESOLUTION, 16, 0,0,0,0);
	
	wswan_vs = SDL_CreateRGBSurface(SDL_HWSURFACE, INTERNAL_WSWAN_WIDTH, INTERNAL_WSWAN_HEIGHT, 16, 0,0,0,0);
	
	wswan_vs_rot = SDL_CreateRGBSurface(SDL_HWSURFACE, INTERNAL_WSWAN_HEIGHT, INTERNAL_WSWAN_WIDTH, 16, 0,0,0,0);
...
void Set_Video_Menu()
{
	...
	//{
		...
		sdl_screen = SDL_SetVideoMode(240, 180, 32, SDL_HWSURFACE);
	//}
}
...
void Set_Video_InGame()
{
	switch(option.fullscreen) 
	{
        ...
        // //#endif
        default:
			sdl_screen = SDL_SetVideoMode(INTERNAL_WSWAN_WIDTH, INTERNAL_WSWAN_HEIGHT, 32, SDL_HWSURFACE);
